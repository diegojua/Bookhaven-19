...
import { 
  ...
  Heart, TrendingUp, Star, Sun, Moon, BarChart3, Clock, BookMarked, Trash2
} from "lucide-react";
                ...
                >
                  ...
                  {book.uploaded_by === user?.id && (
                    <button
                      ...
                      className="absolute top-3 right-14 z-10 bg-white/90 backdrop-blur-sm p-2 rounded-full hover:scale-110 transition-transform hover:bg-red-50"
